		...
		<form action="getpagos" method="POST">
          ...
          <td><input type="text" name="idComercio" maxlength="4" size="4" /></td>
					...
					<tr>
						...
						<td><input type="text" name="importeMin" maxlength="4" size="4" value="0"/></td>
					</tr>
					<tr>
						<td>Importe maximo: </td>
						<td><input type="text" name="importeMax" maxlength="4" size="4" value="10000"/></td>
					</tr>
