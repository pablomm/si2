...
public class GetPagos extends ServletRaiz {
    ...
    */
    ...
    /*Double importeMin = Double.parseDouble(request.getParameter("importeMin"))
    Double importeMax = Double.parseDouble(request.getParameter("importeMax")) */
    String importeMin = request.getParameter("importeMin");
    String importeMax = request.getParameter("importeMax");
		/* Petici&oacute;n de los pagos para el comercio */
    /* Conversion para que funcione como anteriormente */
    List<PagoBean> responsePagos = dao.getPagos(idComercio, importeMin, importeMax);
